...
export const ptPT: Translations = {
    intro: {
        ...
        description:
            'Resolve os enigmas e descobre os segredos do dia mais especial…',
    ...
    progress: {
        ...
        riddlePipAriaLabel: (n, done) =>
            `Enigma ${n}${done ? ' completo' : ''}`,
    },
    ...
    confirm: {
        resetHeader:
            'Tens a certeza de que queres apagar todo o progresso e recomeçar?',
        resetFim:
            'Tens a certeza de que queres recomeçar? Todo o progresso será apagado.',
        okBtn: 'Sim, recomeçar',
        cancelBtn: 'Cancelar',
    },
};
