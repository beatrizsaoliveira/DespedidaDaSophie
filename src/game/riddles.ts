...
export const STAGES: Stage[] = [
  ...
  // ────────────────────────────────────────────────────────
  {
    ...
    teaser:
      'O primeiro segredo da manhã aguarda por ti... Resolve os enigmas e descobre onde começa a aventura.',
    description:
  ...
  // ────────────────────────────────────────────────────────
  {
    ...
    teaser:
      'O segundo segredo esconde-se onde Lisboa se encontra com a imensidão... Resolve os enigmas.',
    description:
  ...
  // ────────────────────────────────────────────────────────
  {
    ...
    teaser:
      'O terceiro e último segredo aguarda na escuridão da noite... Resolve os enigmas e brilha até ao fim.',
    description:
